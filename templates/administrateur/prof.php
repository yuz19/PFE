...
<body>
 ...
 <?php   include ('../../includes/template/header-adminstrateur.php'); nav_affiche("prof");?>
                ...
                <div class="list_eleve">
                    ...
                    <?php foreach ($lprof as  $key=>$value) {?>
                        ...
                        <?php if($value['img_status']==0) {?>
                            ...
                            <img  class='profil'  src='../../uploads/profs/profile-<?= $value['NSS']?>.png?<?=mt_rand()?>' height='70' width="70">
                            <?php }?>
                            <div class="info_elev">
                                <h3><?= $value['Nom']." ".$value['prenom'] ?> </h3>  
                                <p>numero securite social :<?=$value['NSS']?></p>
                            </div>
        ...
        <div class="form_etude "  style="height:780px;">
         ...
         ?></span>
                <input type="number" maxlength="12" name="NSS" placeholder="numero securite social...."><br>
