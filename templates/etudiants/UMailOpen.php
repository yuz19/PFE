...
<body>
 <div class="container">
 <?php include ('../../includes/template/header-etudiant.php');?>
 <?php   include ('../../includes/template/header-etudiant.php'); nav_affiche("mail");?>
    <div class="mail_container2">
        <div class="mail_open">
            <h3>subject:live stream le jour a 18</h3>
            <hr>
            <div class="header_mail">
                <div><img src="../../assets/ICON/user.png" width="60"> </div>
                <div>
                    prof:moqdqsdqs<br>
            ...
            <div class="mail_contenu">
                <div class="link">
                    dddddddddddddddddddd
                </div>
              
                <div class="box_choix">
                   <p> Esque Vous allez venir?</p>
                 <div class="choix">
