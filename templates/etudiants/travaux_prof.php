...
<?php 
 ...
 $profs=$prof->getprof_fromgestion_travaux($_SESSION['Codesection'],$_SESSION['gp']);    
 ...
 <?php   include ('../../includes/template/header-etudiant.php'); nav_affiche("travaux");?>
    ...
    <div class="cont">
        ...
        <?php if(!empty($profs)){?>
            ...
            <a href="travaux.php?id=<?=addslashes(urlencode(serialize($value)))?>" style="color:#000000">
            <div class="prof">
