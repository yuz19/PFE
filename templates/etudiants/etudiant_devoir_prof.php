...
<?php 
 ...
 $profs=$prof->getprof_fromdevoir($_SESSION['Codesection']);    
 ...
 <?php   include ('../../includes/template/header-etudiant.php'); nav_affiche("devoir");?>
    ...
    <div class="cont">
        ...
        <div class="cont_prof">
            ...
            <a href="etudiant_devoir.php?id=<?=addslashes(urlencode(serialize($value)))?>" style="color:#000000">
            <div class="prof">
