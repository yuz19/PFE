...
$travail=$listravaux->get_travaux_prof($id);
if(!isset($travail)){
 ...
 <div class="container">
    ...
    <div class="container_comment_cour">
        <div class="top_container_comment">
            <h1><?=$travail[0]['nom']?></h1>
            <p>Date : <?=str_replace('T',',',$travail[0]['date'])?> <a class="supprimer" href="../../includes/supp_CDT_travaux-inc.php?id=<?=addslashes(urlencode(serialize($id)))?>">supprimer</a></p>
            <hr>
            <br>
