...
if(!isset($cour)){
    header('Location: prof_cours.php');
}
$type=end($tmp);
...
<body>
 ...
 <?php   include ('../../includes/template/header-prof.php'); nav_affiche("cours");?>
    ...
    <div class="top_container_comment">
            ...
            <p>Date de publication : <?=str_replace('T',',',$cour[0]['date'])?> <a class="supprimer" href="../../includes/supp_CDT_cour-inc.php?id=<?=addslashes(urlencode(serialize($id)))?>">supprimer</a></p>
            <hr>
            <br> 
                ...
                <div class="comment_info">
                    ...
                    <a href='read_cour.php?id=<?=$id?>' >
                        ...
                        <img src="../../uploads/cours/file-<?=$cour[0]['NSS']?>-<?=$cour[0]['idcours']?>.jpg"  width="100" >
                        <?php } ?>
                    </a>
                    </div>
