...
class modifier_profil_etudiant_contr extends  modifier_profil_etudiant{
    ...
    public function ModiferUser(){
        if($this->InputVide()==false){
             header("Location: ../../templates/etudiants/profil.php?error=emptyinput");
             exit();
        }
      
       if($this->verifi_uid()==false){
         header("Location: ../../templates/etudiants/profil.php?error=user_errorStat");
         exit();
       }/*
       ...
       if($this->invalidEmail()==false){
         header("Location: ../../templates/etudiants/profil.php?error=email_errorStat");
         exit();
       }
       if($this->verifi_user()==false){
         header("Location: ../../templates/etudiants/profil.php?error=user_existe_or_email_already_used");
         exit();
       }
